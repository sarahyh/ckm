                                                ...
                                                for (let i = 0; i < nGroups; i++) {
                                                    for (let j = 0; j < nTimepts; j++) {
                                                        ...
                                                        var tableRow = {
                                                            ...
                                                            // AMK: demo dataset does not contain every possible input format, so we'll need to test/check the cases commented below to be sure they work
                                                            ...
                                                            // "analysisGroup": (result.consistency === "Analyze separately") ? "Within Subjects Studies" : "Between Subjects Studies", // AMK: analysis groups are hardcoded for the demo, but we need to create a dialogue process for users to bin studies into groups
