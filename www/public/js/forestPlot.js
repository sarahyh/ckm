...
function forestPlot() {
  ...
  // AMK: Seems silly that open cpu returns a session url rather than the data itself.
  ...
  //   // AMK: Here's the math behind the meta-analysis for reference. (difficult to implement vectorized formulas in js)
  //   // w.fixed <- 1 / seES^2
  ...
  // // assign risk of bias [0, 1], where 1 is most severe possible bias (AMK: rating different potential sources of bias on this scale may require expert guidance)
